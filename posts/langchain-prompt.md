---
title: 'LangChain Prompt 入门：从 PromptTemplate 到 PipelinePromptTemplate'
description: '本文介绍 LangChain 中 Prompt 的核心概念，以及 PromptTemplate、ChatPromptTemplate、MessagesPlaceholder 和 PipelinePromptTemplate 的基本用法。'
...
## 4. PipelinePromptTemplate：把多个子 Prompt 组装起来
...
4. 需要模块化复用时，再补 `PipelinePromptTemplate`
